...
export const glanceCards: GlanceCard[] = [
  {
    ...
    severity: "high",
    title: "New Rash post-Acetaminophen",
    reason: "Unconfirmed allergic reaction reported via AI-patient session 2h ago.",
    action: "Review Source & Update Plan ↗",
  ...
  },
  {
    ...
    label: "PLAN CHECK",
    severity: "medium",
    title: "Dosage Mismatch vs. Active Plan",
    reason: "Recent follow-up suggests dosage update not yet reflected in current Care Plan.",
    action: "Compare with Care Plan ↗",
  ...
  },
  {
    ...
    severity: "medium",
    title: "Dose Guidance Needed (Nurse Escalation)",
    reason: "Staff coordination note waiting for clinician response since this morning.",
    action: "Review Team Escalation ↗",
